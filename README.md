...
2. Дан файл, в котором встречаются даты. Каждая дата — это число, месяц и год в формате `DD.MM.YYYY`. Даты отделены от остального текста пробелами. Найти наименьшую дату.
