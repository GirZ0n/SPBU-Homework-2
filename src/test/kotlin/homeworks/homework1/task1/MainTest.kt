...
internal class Task1Test {
    ...
    fun Reverse_BeginGraterThanEnd_MustWork() {
        ...
        val actual = intArrayOf(1, 2, 3, 4, 5)
        reverse(actual, 2, 0)
        assertArrayEquals(expected, actual)
    ...
    fun Reverse_BeginLessThanZero_MustWork() {
        val expected = intArrayOf(3, 2, 1, 4, 5)
        val actual = intArrayOf(1, 2, 3, 4, 5)
        reverse(actual, -10, 3)
        assertArrayEquals(expected, actual)
    }
    ...
    fun Reverse_ArrayOfIdenticalElements_MustWork() {
        ...
        val actual = intArrayOf(1, 1, 1, 1, 1)
        reverse(actual, 2, 3)
        assertArrayEquals(expected, actual)
    }
    ...
    fun Reverse_SimpleArray1_MustWork() {
        val expected = intArrayOf(1, 3, 2, 4, 5)
        val actual = intArrayOf(1, 2, 3, 4, 5)
        reverse(actual, 1, 3)
        assertArrayEquals(expected, actual)
    }
    ...
    fun Reverse_SimpleArray2_MustWork() {
        val expected = intArrayOf(1, 4, 3, 2, 5)
        val actual = intArrayOf(1, 2, 3, 4, 5)
        reverse(actual, 1, 4)
        assertArrayEquals(expected, actual)
    }
    ...
    fun Reverse_SeveralReverses_MustWork() {
        val expected = intArrayOf(2, 4, 5, 3, 1)
        val actual = intArrayOf(1, 2, 3, 4, 5)
        reverse(actual, 1, 3)
        reverse(actual, 2, 5)
        reverse(actual, 0, 5)
